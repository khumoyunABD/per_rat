...
//           .where((show) => show.id.contains(widget.showRating.title))
//           .isNotEmpty;

//       if (showExists) {
//         //
//         await ratingCollectionRef.doc(widget.showRating.title).set({
...
//         _selectedProgress = widget.showRating.completedEpisodes.toString();
...
//     final int showProgress = widget.showRating.completedEpisodes ?? 0;
...
//     return Scaffold(
//       appBar: AppBar(
//         title: Text(widget.showRating.title),
//         centerTitle: true,
//         actions: [
//           IconButton(
//             onPressed: _submit,
...
//                       content:
//                           Text("${widget.showRating.title} has been deleted"),
//                     ),
//                   );
//                 },
//                 child: const Padding(
