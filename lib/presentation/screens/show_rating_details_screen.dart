...
//       if (anime.title == showRating.title) {
//         return anime;
//       }
//     }
//     return null;
...
//             shape: CircleBorder(),
//             onPressed: () {
//               // animeSet can be null if _fetchAnime hasn't completed or failed.
//               // EditScoreScreen is designed to handle a null anime.
//               Navigator.of(context).push(
//                 MaterialPageRoute(
//                     builder: (ctx) => EditScoreScreen( // Changed to EditScoreScreen
//                           anime: animeSet, // Pass animeSet
